...
class PacientesAgentes extends StatefulWidget {
  AgentesTodos agente;

  PacientesAgentes({@required this.agente, Key key}) : super(key: key);

  @override
  _PacientesAgentesState createState() => _PacientesAgentesState();
}

class _PacientesAgentesState extends State<PacientesAgentes> {
  @override
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Expanded(
          flex: 0,
          child: Text(
            "Você não tem nenhuma paciente registrada neste agente de saúde!",
            style: TextStyle(
