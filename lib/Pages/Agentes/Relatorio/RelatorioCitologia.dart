...
class RelatorioCitologia extends StatefulWidget
{
  @override
  _RelatorioCitologiaState createState() => _RelatorioCitologiaState();
...
class _RelatorioCitologiaState extends State<RelatorioCitologia>
{
  String result = "ordem";
    ...
    return FutureBuilder<List<PacientesTodos>>(
        ...
        builder: (context, AsyncSnapshot<List<PacientesTodos>> snapshot) {
          if (snapshot.connectionState == ConnectionState.none ||
            ...
            if(snapshot.data[widget.idPaciente].citologia != null) {

              if(btnDate == true) {
                snapshot.data[widget.idPaciente].citologia.sort((a,b) => a.dataLaudo.substring(6, 10).compareTo(b.dataLaudo.substring(6, 10)));
              }

              return listarCitologias(snapshot.data[widget.idPaciente].citologia);
            } else {
          ...
          Flexible(
            child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  if(result == "negativos") {
                    if (citologias[index].resultadoRegistro == "Negativo") {
                      return FlatButton(
                        onPressed: () {},
                        child: Column(
                          children: <Widget>[
                    ...
                    if (citologias[index].resultadoRegistro == "Positivo") {
                      return FlatButton(
                        onPressed: () {},
                        child: Column(
                          children: <Widget>[
