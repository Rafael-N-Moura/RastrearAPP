...
class Laudo extends StatefulWidget {
  @override
  _LaudoState createState() => _LaudoState();
  ...
  Laudo({@required this.paciente});
}

class _LaudoState extends State<Laudo> {
                      ...
                      child: SizedBox.expand(
                        child: FlatButton(
                          ...
                          onPressed: () {
                            ...
                            if (widget.paciente.citologia == null)
                              widget.paciente.citologia =
                                  List<CitologiaTodos>();
                            widget.paciente.citologia.add(CitologiaTodos(
                              citologiaID: widget.paciente.id,
