...
class LaudoEditM extends StatefulWidget {
  @override
  _LaudoEditMState createState() => _LaudoEditMState();
...
class _LaudoEditMState extends State<LaudoEditM> {
  String result;
  ...
  void initState() {
    ...
    widget.DataCtrl.text = widget.paciente.mamografia[widget.id].dataLaudo;
    widget.DetalhesCtrl.text =
        widget.paciente.mamografia[widget.id].detalhesRegistro;
    widget.ControleCtrl.text = widget.paciente.mamografia[widget.id].controle;

    if (widget.paciente.mamografia[widget.id].resultadoRegistro == "Positivo") {
                      ...
                      child: SizedBox.expand(
                        child: FlatButton(
                          ...
                          onPressed: () {
                            ...
                            setState(() {
                              widget.paciente.mamografia[widget.id]
                                  .mamografiaID = widget.id;
                              widget.paciente.mamografia[widget.id].dataLaudo =
                                  widget.DataCtrl.text;
                              widget.paciente.mamografia[widget.id]
                                  .resultadoRegistro = result.toString();
                              widget.paciente.mamografia[widget.id]
                                  .detalhesRegistro = widget.DetalhesCtrl.text;
                              widget.paciente.mamografia[widget.id].controle =
